...
public class RadiusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Area".equals(action)) {
            result = Math.PI * Math.pow(radius, 2);  // Calculate area of the circle
        } else if ("Perimeter".equals(action)) {
            result = 2 * Math.PI * radius;  // Calculate perimeter of the circle
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RadiusServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>For the circle with radius: " + radius + "</h1>");
            out.println("<h1>" + action + " is : " + result + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
